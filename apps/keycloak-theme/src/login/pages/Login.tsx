                ...
                <div id="kc-registration-container" className="text-center">
                    <div id="kc-registration">
                        <span className="text-sm text-gray-600">
                            {msg("noAccount")}{" "}
                            <a tabIndex={8} href={url.registrationUrl} className="text-brand-primary hover:underline font-medium">
                                {msg("doRegister")}
                            </a>
                        </span>
                    </div>
                ...
                <>
                    {realm.password && social?.providers !== undefined && social.providers.length !== 0 && (
                        <div id="kc-social-providers" className={kcClsx("kcFormSocialAccountSectionClass")}>
                            <Separator label={msgStr("identity-provider-login-label")} className="my-4" />
                            <ul
                                className={cn(
                    ...
                    {realm.password && (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2">
                                <Label htmlFor="password" className={cn(kcClsx("kcLabelClass"), "text-gray-600")}>
                                    {msg("password")}
                                </Label>
                            ...
                            <div className="flex flex-row justify-between items-center gap-2">
                                <div id="kc-form-options" className="flex flex-row gap-2">
                                    {realm.rememberMe && !usernameHidden && (
                                        <div className="flex flex-row gap-2 items-center">
                                            <Checkbox name="rememberMe" id="rememberMe" defaultChecked={!!login.rememberMe} />
                                ...
                                <div className="flex justify-end">
                                    {realm.resetPasswordAllowed && (
                                        <a tabIndex={6} href={url.loginResetCredentialsUrl} className="text-brand-primary hover:underline text-sm">
